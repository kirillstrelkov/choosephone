...
module PhonesHelper
  ...
  DEFAULT_DESC = 'If you are tired of comparing multiple phones\' features '\
   'and don\'t know which one to choose. '\
   'This site will try to help you by sorting entered phones using '\
   'their points/scores. Most of modern phone vedors are supported like: '\
   'sony, lg, samsung, apple, nokia and etc. '\
   'Functionality is based on http://www.versus.com/ web site.'
