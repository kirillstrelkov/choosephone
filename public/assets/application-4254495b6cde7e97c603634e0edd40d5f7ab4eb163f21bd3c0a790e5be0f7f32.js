...
(function() {
  var format_row_data, format_row_price, get_translation, init, set_points_and_price, set_price, sort_phones, update_row_data, update_title;
  ...
  sort_phones = function() {
    ...
    return $('tr.phone').each(function(i, phone) {
      return $(phone).find('td.place').text(i + 1);
    });
  };
  ...
  init = function() {
    var $share_results, content, cur_client_width, href, max_chars, max_client_width, text;
