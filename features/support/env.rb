...
Capybara.register_driver :selenium do |app|
  driver_folder = ENV.fetch('DRIVER_FOLDER', '')
  case $browser
  when :chrome
    service = Selenium::WebDriver::Service.chrome(
      path: "#{driver_folder}/chromedriver"
    )
    Capybara::Selenium::Driver.new(
      app, browser: $browser, service: service
    )
  when :firefox
    service = Selenium::WebDriver::Service.firefox(
      path: "#{driver_folder}/geckodriver"
    )
    Capybara::Selenium::Driver.new(app, browser: $browser, service: service)
  else
    puts "Unsupport browser #{$browser}"
    exit(1)
  end
end
